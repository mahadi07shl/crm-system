...
@section('content')
    ...
    <header class="site-header">
        <a href="#" class="brand">Skills Hut Ltd <span>|</span> CRM</a>
    ...
    <main>
        <div class="login-card">
            ...
            <p class="card-subtitle">Skills Hut CRM — Admin Portal</p>
    ...
    <footer class="site-footer">
        <div>
            <span style="color: var(--text-dark); font-weight: 700;">Skills Hut Ltd | CRM</span>
